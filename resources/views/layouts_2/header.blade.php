          ...
          <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="#">
              ...
              <b class="logo-icon ps-2">
                ...
                <!-- Dark Logo icon -->
                <img
                  src="{{asset('imagenes/sistema/mgl_logo.png')}}"
                  alt="homepage"
                  class="light-logo"
                  width="25"
                />
          ...
          <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
            ...
            <ul class="navbar-nav float-end">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="mdi mdi-bell font-24"></i></a>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{asset('imagenes/usuarios/cesar_maya.png')}}" alt="user" class="rounded-circle" width="31"/>
                </a>
                <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                    ...
                    <form action="{{ route('logout') }}"method="POST">
                        ...
                        <button type="submit" class="dropdown-item text-black">
                            <i class="fa fa-power-off me-1 ms-1 text-danger ml-3"></i>
                            Cerrar Sesión
                        </button>
                    </form>
                </ul>
