...
<i class="fas fa-industry ml-4" aria-hidden="true"></i> Configuración - Grupo Empresarial
@endsection
<!-- ************************************************************* -->
@section('contenido')
<div class="row">
        ...
        <div class="card card-outline card-info">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 col-md-6 mb-4 mb-md-0">
                            <h4 class="card-title">
                                <strong>Registro Nuevo Grupo Empresarial</strong>
                            </h4>
                        </div>
                        <div class="col-12 col-md-6 mb-4 mb-md-0">
            ...
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-12">
                        <form action="{{ route('grupo_empresas.store') }}" class="form-horizontal row" method="POST" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('post')
