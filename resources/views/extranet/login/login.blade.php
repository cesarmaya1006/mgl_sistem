...
<body>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="row text-white d-flex justify-content-center pt-5">
                                ...
                                <div class="col-12 col-md-10">
                                    <div class="row pl-4 text-red fw-bold">
                                        <div class="col-12" style="background-color: white; border-radius: 5px;
                                ...
                                <div class="col-12 col-md-10">
                                    ...
                                    <form class="row mt-2" style="width: 100%;" action="{{ route('login_acceso') }}" method="post">
                                    @method('post')
                                    @csrf
                                        <div class="col-12 ">
                                            ...
                                            <div class="row mt-3 mb-3" style="width: 100%;">
                                                ...
                                                <div class="col-1 text-right">
                                                    <button class="btn btn-secondarybtn-xs" type="button" id="botoneye"><i class="fa fa-eye-slash text-white" id="togglePassword" aria-hidden="true"></i></button>
                                                </div>
                                            </div>
                                            <div class="row mt-3 mb-3" style="width: 100%;">
    ...
    <script src="{{asset('js/extranet/login/login.js')}}"></script>
</body>
</html>
